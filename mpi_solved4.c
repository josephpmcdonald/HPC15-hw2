 ...
 * LAST REVISED: 01/24/09
 ...
 BUG: MPI_Reduce was called within the section devoted to non-master tasks, thus
    sum was never initialized for the master. Moved this function outside to be
    called by all tasks and subsequently print the correct (by rounding) answer.
