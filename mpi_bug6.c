 ...
 *
 *
 * BUG: Process 2 was supplying an empty array of requests to MPI_Waitall, though
 * it made no requests since it was a blocking operation. Changed nreqs = 0 for
 * process 2.
 *
 *  Also made the offset for process 1 zero since it was initially set at REPS
 *  which was halfway through the allocated array and produced some unpredictable
 *  behavior.
 *
 *
 ******************************************************************************/
