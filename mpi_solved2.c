...
*
*
*BUG FOUND: Beta was initialized as a float so process 1 could not receive the int alpha from 0. 
*I changed beta to an int and made the appropriate updates in line with that.
